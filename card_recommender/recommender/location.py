...
def location_scoring_cards(user_input,card_preference_banks):
    ...
    # location score the banks which scored high on card preference based on the distance
        ...
        print(bank_location_scores)
    # then assign a location score to each card
    
user_input = {"area":"Basundhara","city":"Dhaka"}
card_preference_banks = ["Dutch Bangla", "Mutual Trust"]
location_scoring_cards(user_input,card_preference_banks)